...
namespace WpfApplication1
{
    public class userHistory
    {
        ...
        /// </summary>
        public List<userLog> userLogHistory;
        ...
        /// <param name="Port"></param>
        /// <summary>
        public void writeUserLog(string HostName, string UserName, String Password, int Port)
        {
            if (HostName == null || UserName == null || Password == string.Empty)
                return;

            var path = $"{Directory.GetCurrentDirectory()}\\userHistory.txt";
